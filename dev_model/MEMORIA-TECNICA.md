...
El usuario puede acceder a estos modelos en la carpeta [Documentación API](app/documentacion-api.md), donde se encuentran organizados para facilitar su revisión. Además, en la carpeta [dev_model](Clasificancer/dev_model) se incluyen dos notebooks principales:
